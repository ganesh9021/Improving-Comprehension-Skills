...
const Exercise2Midcontent = () => {
  ...
  const handleSubmit = () => {
    ...
    if (!selectedAns1 || !selectedAns2) {
      setFeedback(t("instr5")); //Please select atleast one option for each question.
      setBGColor("danger");
    } else if (answer1Check && answer2Check) {
      setFeedback(t("instr6")); //Both the answers are correct!
      setDisable1(true);
      setDisable2(true);
      setBGColor("success");
    } else if (answer1Check) {
      setFeedback(t("instr7")); //Only first answer is correct!
      setDisable1(true);
      setBGColor("warning");
    } else if (answer2Check) {
      //only second answer is correct!
      setFeedback(t("instr8"));
      setDisable2(true);
      setBGColor("warning");
    } else {
      setFeedback(t("instr9")); //Both the answers are incorrect!
      setBGColor("danger");
    }
  };
    ...
    <div className="container-fluid overflow-auto">
      <div className="row">
        ...
        >
          ...
          <div className="p-3">
            <div className="mb-2">{data[1].comprehension_data}</div>
...
export default Exercise2Midcontent;
